    ...
    <>
      <div className="flex items-center gap-4 mb-6">
        <Button
          variant="ghost"
          size="icon"
          onClick={() => navigate("/admin/bus-owners")}
        >
        ...
        <div className="flex-1">
          ...
          <p className="text-muted-foreground">
            Owner ID: {busOWnerDetail?.id || id}
          </p>
        </div>
        <div className="flex gap-2">
          <Button
            onClick={() => onOpen("editBusOwner")}
            variant="outline"
            className="gap-2"
          >
        ...
        <Card className="lg:col-span-1">
          <CardHeader>
            <CardTitle className="flex items-center justify-between">
              ...
              <Badge
                variant={
                  busOWnerDetail.status === "Active" ? "default" : "destructive"
                }
              >
          ...
          <CardContent className="space-y-4">
            ...
            <div className="text-center">
              <h3 className="text-xl font-semibold">
                {busOWnerDetail.company ?? "N/A"}
              </h3>
              <p className="text-sm text-muted-foreground">
                {busOWnerDetail.type ?? "N/A"}
              </p>
              <p className="text-sm text-muted-foreground mt-1">
                Owner: {busOWnerDetail.name}
              </p>
            </div>
            ...
            <div className="pt-4 border-t space-y-2">
              <div className="text-sm">
                ...
                {busOWnerDetail?.panNumber ?? "N/A"}
              </div>
              <div className="text-sm">
                <span className="text-muted-foreground">Registration:</span>{" "}
                {busOWnerDetail?.registrationNumber ?? "N/A"}
              </div>
              <div className="text-sm">
                <span className="text-muted-foreground">Bank:</span>{" "}
                {busOWnerDetail?.bankDetails ?? "N/A"}
              </div>
            </div>
          </CardContent>
        </Card>
